            ...
            {parties.data?.items.map((party) => (
              <li key={party.id}>
                ...
                >
                  ...
                  {party.gstin && (
                    <p className="mt-0.5 font-mono text-xs text-muted">{party.gstin}</p>
                  )}
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          <Field label="City">
            <input name="city" className="field" defaultValue={party?.city ?? ""} />
          </Field>
          <Field label="PIN code">
            <input
              ...
              className="field"
              maxLength={6}
              defaultValue={party?.pincode ?? ""}
            />
          </Field>
        </div>
        <div className="grid grid-cols-2 gap-3">
          <Field label="Phone">
            <input name="phone" className="field" defaultValue={party?.phone ?? ""} />
          </Field>
          <Field label="Email">
