...
How Traxac talks to the government portals, what it needs to do so, and what
...
```bash
export TRAXAC_SANDBOX_ENABLED=1
export TRAXAC_SANDBOX_GSTIN=…          # the GSTIN the sandbox account covers
export TRAXAC_SANDBOX_USERNAME=…
export TRAXAC_SANDBOX_PASSWORD=…
export TRAXAC_SANDBOX_CLIENT_ID=…
export TRAXAC_SANDBOX_CLIENT_SECRET=…
