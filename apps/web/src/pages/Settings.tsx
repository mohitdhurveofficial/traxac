          ...
          <label className="flex items-start gap-2 text-sm">
            ...
            <span>
              ...
              <span className="block text-xs text-muted">
                You can still do it manually per invoice.
              </span>
            </span>
          </label>
          <label className="flex items-start gap-2 text-sm">
            <input
              name="autoGenerateEwb"
              type="checkbox"
              className="mt-0.5 size-4 rounded border-line"
    ...
    <div className="max-w-3xl space-y-4">
      <div className="rounded-xl border border-brand-100 bg-brand-50 p-4 text-sm">
        ...
        <p className="mt-1 text-brand-900/80">
          ...
          <span className="font-mono text-xs">einvoice1.gst.gov.in</span>) and the e-Way Bill portal
          (<span className="font-mono text-xs">ewaybillgst.gov.in</span>), then add the username and
          password here. Keep the environment on sandbox until you have tested.
        </p>
      </div>
        ...
        <ul className="divide-y divide-line">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 text-xs text-muted">
                  ...
                  {credential.lastVerifiedAt &&
                    ` · verified ${formatDateTime(credential.lastVerifiedAt)}`}
                </p>
          ...
          {(credentials.data?.items.length ?? 0) === 0 && (
            <li className="px-4 py-8 text-center text-sm text-muted">
              No credentials yet. Invoices can still be created and printed — only the IRN and e-Way
              Bill steps need them.
            </li>
          )}
        </ul>
      </section>
      ...
      >
        ...
        >
          ...
          <Field
            label="Client ID"
            hint="From NIC or your GSP. Leave blank to use the platform default."
          >
